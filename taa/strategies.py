...
STRATEGIES = [
    ...
    },
    {
        ...
        "riskAssets": ["SPY", "VGK", "EWJ", "EEM", "VNQ", "RWX", "IEF", "TLT", "DBC", "GLD"],
        "safeAssets": ["IEF"],
    ...
    },
    {
        ...
        "riskAssets": ["SPY", "QQQ", "IWM", "VGK", "EWJ", "EEM", "VNQ", "DBC", "GLD", "HYG", "LQD"],
        "safeAssets": ["BIL", "IEF"],
        "frequency": "M",
    },
    {
    ...
    },
    {
        ...
        "safeAssets": ["BIL"],
        "weights": [0.05, 0.05, 0.05, 0.05, 0.1, 0.1, 0.05, 0.05, 0.05, 0.05, 0.1, 0.1, 0.2],
        "frequency": "M",
    },
    {
        "tag": "DAA",
    ...
    },
    {
        ...
        "safeAssets": ["IEF"],
        "weights": [0.51, 0.06, 0.06, 0.05, 0.05, 0.05, 0.05, 0.04, 0.03, 0.03, 0.03, 0.02, 0.02],
        "frequency": "M",
    },
    {
        "tag": "AAA",
        "name": "Adaptive Asset Allocation",
        "riskAssets": ["IEF", "SPY", "VNQ", "RWX", "DBC", "EEM", "VGK", "TLT", "GLD", "EWJ"],
