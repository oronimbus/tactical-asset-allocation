...
@pytest.mark.parametrize("assets, dates, expected", [(TEST_ASSETS, TEST_DATES, 8)])
...
@pytest.mark.parametrize("assets, dates, expected", [(TEST_ASSETS, TEST_DATES, 1 / 4)])
...
@pytest.mark.parametrize(
    "ret, dts, func, lb, shr, sf, expected",
    [
...
@pytest.mark.parametrize(
    "ret, sig, dts, ca, ra, sa, k, expected",
    [
